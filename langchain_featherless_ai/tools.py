...
class FeatherlessAiToolInput(BaseModel):
    """Input schema for FeatherlessAi tool.
...
class FeatherlessAiTool(BaseTool):  # type: ignore[override]
    """FeatherlessAi tool.
    ...
    args_schema: Type[BaseModel] = FeatherlessAiToolInput
