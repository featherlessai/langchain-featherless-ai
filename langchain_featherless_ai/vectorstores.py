...
class FeatherlessAiVectorStore(VectorStore):
    # TODO: Replace all TODOs in docstring.
    """FeatherlessAi vector store integration.
    ...
    Instantiate:
        .. code-block:: python
            ...
            vector_store = FeatherlessAiVectorStore(
                collection_name="foo",
    ...
    @classmethod
    def from_texts(
        cls: Type[FeatherlessAiVectorStore],
        texts: List[str],
        embedding: Embeddings,
        metadatas: Optional[List[dict]] = None,
        **kwargs: Any,
    ) -> FeatherlessAiVectorStore:
        store = cls(
            embedding=embedding,
        )
