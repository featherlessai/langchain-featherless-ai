...
class FeatherlessAiRetriever(BaseRetriever):
    ...
    """FeatherlessAi retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``langchain-featherless-ai`` and set environment variable
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-featherless-ai import FeatherlessAiRetriever

            retriever = FeatherlessAiRetriever(
                # ...
            )
