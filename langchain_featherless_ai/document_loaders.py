...
class FeatherlessAiLoader(BaseLoader):
    ...
    """
    FeatherlessAi document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import FeatherlessAiLoader

            loader = FeatherlessAiLoader(
                # required params = ...
                # other params = ...
            )
